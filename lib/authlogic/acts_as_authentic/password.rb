    ...
    module Password
      ...
      module Callbacks
        ...
        def self.included(klass)
          ...
          if (klass.respond_to?(:metaclass) and klass.metaclass.method_defined?(:set_callback)) or
             (klass.respond_to?(:singleton_class) and klass.singleton_class.method_defined?(:set_callback))
